...
class TSNDataSet(data.Dataset):
    def __init__(self, root_path, list_file,
                 ...
                 image_tmpl='img_{:05d}.jpg',img_start_idx=1, transform=None,
    ...
    def _load_image(self, directory, idx):
        ...
        #######################################################
        #if os.path.exists(os.path.join(self.root_path, directory, self.image_tmpl.format(0))):
        #    idx = idx - 1  # frame number start from 0
        #######################################################
...
#             print (offsets)
    ...
    def _get_test_indices(self, record):
        ...
        elif self.mode==2:   # tsm twice sample
            tick = (record.num_frames - self.new_length + 1) / float(self.num_segments)
