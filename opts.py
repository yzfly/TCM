...
parser.add_argument('dataset', type=str, choices=['ucf101', 'hmdb51', 'kinetics', 'something','somethingv2','jhmdb', 'tinykinetics'])
parser.add_argument('modality', type=str, choices=['gray', 'RGB', 'Flow', 'RGBDiff'])
parser.add_argument('train_list', type=str)
parser.add_argument('val_list', type=str)
parser.add_argument('--img_start_idx', type=int, default=1)
...
parser.add_argument('--flow_prefix', default="flow_{}_", type=str)
