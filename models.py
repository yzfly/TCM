...
TSN Configurations:
    ...
    dropout_ratio:      {}
        ...
        if (base_model[:3] == 'TCM'):
            if 'resnet50' in base_model:
                from resnet_TSM import resnet50 as resnet
                self.base_model = resnet(True, shift='TSM', num_segments = self.num_segments, enable_TCM = 1)
                print("Backbone: resnet50")
            elif 'resnet101' in base_model:
                from resnet_TSM import resnet101 as resnet
                self.base_model = resnet(True, shift='TSM', num_segments = self.num_segments, enable_TCM = 1)
            ...
            if self.non_local:
                ...
                from non_local import make_non_local_resnet50_layer4 as make_non_local
    ...
    def forward(self, input, temperature):
        ...
        if self.reshape:
            ...
            output = output.squeeze(3).squeeze(1)
